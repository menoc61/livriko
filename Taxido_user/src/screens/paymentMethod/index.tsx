    ...
    <View style={[external.main, { backgroundColor: linearColorStyle }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.listContent} >
        ...
        <View style={styles.sideSpace}>
          {taxidoSettingData?.cabbooking_values?.activation?.driver_tips == 1 ? (
            <View>
              <Text
                style={[
                  styles.tips,
          ...
          {taxidoSettingData?.cabbooking_values?.activation?.coupon_enable == 1 && (
            <>
              <View
                style={[
                  styles.containerCoupon,
          ...
          >
            {taxidoSettingData?.cabbooking_values?.activation?.rider_wallet == 1 && (
              <TouchableOpacity
                onPress={cashSelect}
                activeOpacity={0.9}
                style={{
            ...
            {taxidoSettingData?.cabbooking_values?.activation?.online_payments == 1 && (
              <TouchableOpacity
