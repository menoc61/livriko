          ...
          <View style={[external.mv_5]}>
            <DetailContainer
              value={[
                ...
                Number(billDetail?.ride_fare).toFixed(2),
              ]}
        ...
        {billDetail?.additional_distance_charge > 0 && (
          <View style={[external.mv_5]}>
            <DetailContainer
              value={[
                billDetail?.currency_symbol,
                Number(billDetail?.additional_distance_charge).toFixed(2),
              ]}
        ...
        {billDetail?.vehicle_rent > 0 && (
          <View style={[external.mv_5]}>
            <DetailContainer
              value={[
                billDetail?.currency_symbol,
                Number(billDetail?.vehicle_rent).toFixed(2),
              ]}
        ...
        {billDetail?.additional_minute_charge > 0 && (
          <View style={[external.mv_5]}>
            <DetailContainer
              value={[
                billDetail?.currency_symbol,
                Number(billDetail?.additional_minute_charge).toFixed(2),
              ]}
        ...
        {billDetail?.additional_weight_charge > 0 && (
          <View style={[external.mv_5]}>
            <DetailContainer
              value={[
                billDetail?.currency_symbol,
                Number(billDetail?.additional_weight_charge).toFixed(2),
              ]}
        ...
        {billDetail?.bid_extra_amount > 0 && (
          <View style={[external.mv_5]}>
            <DetailContainer
              value={[
                billDetail?.currency_symbol,
                Number(billDetail?.bid_extra_amount).toFixed(2),
              ]}
        ...
        {billDetail?.commission > 0 && (
          <View style={[external.mv_5]}>
            <DetailContainer
              value={[
                billDetail?.currency_symbol,
                Number(billDetail?.commission).toFixed(2),
              ]}
              title={translateData.commission}
            />
          </View>
        )}
        {Array?.isArray(billDetail?.extra_charges) &&
          billDetail.extra_charges.some((item:any) => item?.amount > 0) &&
          billDetail?.extra_charges.map(
            (item:any, index:any) =>
              item?.amount > 0 && (
                <View key={index} style={[external.mv_5]}>
                  <DetailContainer
                    title={item?.title}
                    value={[
                      billDetail?.currency_symbol,
        ...
        {billDetail?.tax > 0 && (
          <View style={[external.mv_5]}>
            <DetailContainer
              value={[
                billDetail?.currency_symbol,
                Number(billDetail?.tax).toFixed(2),
              ]}
        ...
        {billDetail?.platform_fees > 0 && (
          <View
            ...
            <Text
              ...
              {billDetail?.currency_symbol}
              {Number(billDetail?.platform_fees).toFixed(2)}
            </Text>
          </View>
        )}
      </View>
      ...
      <View style={styles.detailContainerText}>
        <View
          ...
          <Text
            ...
            {billDetail?.currency_symbol}
            {Number(billDetail?.total).toFixed(2)}
          </Text>
        </View>
      </View>
    </View>
