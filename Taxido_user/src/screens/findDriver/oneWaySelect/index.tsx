...
export function OneWaySelect() {
  ...
  const cities = [
    {
      label: "220 Yonge St, Toronto, ON M5B 2H1, Canada",
      text: "Pickup location",
      type: "start",
    },
    {
      label: "17600 Yonge St, Newmarket, ON L3Y 4Z1, Canada",
      text: "Destination",
      type: "middle",
    },
  ];
      ...
      <View style={[styles.header, { flexDirection: viewRTLStyle }]}>
        ...
        <View
          style={[
            styles.infoIcon,
            {
              borderColor: isDark ? appColors.darkBorder : appColors.blackColor,
            },
          ]}
        >
          <Text
            style={[
              styles.infoText,
              { color: isDark ? appColors.darkBorder : appColors.blackColor },
            ]}
          >
            !
          </Text>
    ...
    <View style={styles.main}>
      ...
      >
        ...
        >
          <View style={styles.citiesView}>
            {cities.map((step, index) => (
              <View
                key={index}
                style={[styles.stepContainer, { flexDirection: viewRTLStyle }]}
              >
        ...
        <View style={[styles.selectorRow]}>
          <View
            style={[styles.dropdownWrapper, { flexDirection: viewRTLStyle }]}
          >
            <DropDownPicker
              open={openCarType}
