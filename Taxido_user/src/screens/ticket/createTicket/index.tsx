  ...
  const TicketRequest = async () => {
    ...
    try {
      ...
      if (response.ok && responseData.id) {
        ...
        notificationHelper(
          "",
          responseData.message || translateData.ticketFail,
          "error",
        );
      }
    } catch (error) {
    ...
    <View style={{ backgroundColor: linearColorStyle, height: "100%" }}>
      ...
      <ScrollView style={styles.mainInput} showsVerticalScrollIndicator={false}>
        <View>
          ...
          />
          {subjectError ? (
            <Text style={[styles.errorText, { top: windowHeight(5.7) }]}>
              {subjectError}
            </Text>
          ) : null}
        </View>
        <View>
          ...
          <TextInput
            ...
            onChangeText={text => {
              ...
              if (!text.trim()) {
                setDescriptionError(
                  translateData.ticketPleaseEnterdescriptionnnn,
                );
              } else {
                setDescriptionError("");
              }
        ...
        />
        {priorityError ? (
          <Text style={[styles.errorText, { top: windowHeight(2) }]}>
            {priorityError}
          </Text>
        ) : null}
        ...
        <View>
          ...
          />
          {departmentError ? (
            <Text style={[styles.errorText, { top: windowHeight(3) }]}>
              {departmentError}
            </Text>
          ) : null}
        </View>
