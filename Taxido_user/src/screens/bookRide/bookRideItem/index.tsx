...
export const BookRideItem = memo(function BookRideItem({
  item,
  onPress,
  isSelected,
  onPressAlternate,
  ...
  const prefsTotal =
    isSelected && Array.isArray(selectedPrefsValue)
      ? selectedPrefsValue.reduce(
  ...
  if (isCouponApplicable) {
    ...
    discountedFare = Math.max(
      0,
      Number((originalFare - couponSaving).toFixed(2)),
    );
    ...
    <TouchableOpacity
      ...
      <View style={{flexDirection: "row"}}>
        <View
          ...
          <Image
            style={[styles.img, isDisabled && !isSelected && {opacity: 0.5}]}
        ...
        <View
          style={[
            ...
            external.mh_5,
            external.mv_5,
            {height: windowHeight(30), marginTop: windowHeight(7.5)},
          ]}>
          <View style={external.fd_row}>
            ...
            <View
              style={[
                external.fd_row,
                {alignItems: "center", marginHorizontal: windowWidth(3)},
              ]}>
              <UserFillSmall2 />
              <Text
                style={[
