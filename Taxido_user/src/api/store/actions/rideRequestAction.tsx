import { RIDE_REQUEST, UPDATE_RIDE_REQUEST, RIDE_LOCATION, FIND_DRIVER_REQUESTS } from "../types/index";
...
export const findDriverRequestsAction = createAsyncThunk(
  FIND_DRIVER_REQUESTS,
  async (service_type?: string) => {
    const response = await rideRequestServices.getRideRequests(service_type);
    return response?.data;
  }
);
