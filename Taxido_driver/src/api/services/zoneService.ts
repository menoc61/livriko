import { zoneUpdate, zoneRental, zoneCurrent, driverStatus } from '../endpoints/zoneEndPoint'
...
export const driversStatus = async (data: ZoneUpdatePayload) => {
  return POST_API(data, driverStatus)
    .then(res => {
      return res
    })
    .catch(e => {
