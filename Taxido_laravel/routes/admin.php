...
Route::group(['middleware' => ['localization']], function () {
    ...
    Route::group(['middleware' => ['auth'], 'namespace' => 'Admin', 'as' => 'admin.'], function () {
        ...
        Route::get('download-firebase', 'SettingController@downloadFirebase')->name('download-firebase');
        ...
        Route::get('chat/users', 'ChatController@getUsersByRole')->name('chat.users');
        Route::get('chat/recent', 'ChatController@recent')->name('chat.recent');
