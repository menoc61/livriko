...
<link rel="icon" href="{{ getSettings()['general']['favicon_image']?->original_url ?? asset('images/favicon-livriko.png') }}" type="image/x-icon">
<link rel="shortcut icon" type="image/x-icon" href="{{ getSettings()['general']['favicon_image']?->original_url ?? asset('images/favicon-livriko.png') }}">
<title>{{ config('app.title') }} - @yield('title')</title>
<link rel="apple-touch-icon" href="{{ asset('front/images/logo/favicon-livriko.png') }}">
