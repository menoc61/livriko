<?php $__env->startSection('title', __('static.chats.chats')); ?>
                            ...
                            <div class="inside">
                                <div class="contentbox-title">
                                    <div class="contentbox-subtitle">
                                        <h3><?php echo e(__('static.chats.chats')); ?></h3>
                                    </div>
                                </div>
                                    ...
                                    <ul class="nav nav-tabs driver-tabs custom-scrollbar" id="userRoleTabs" style="flex-wrap: nowrap; overflow-x: auto; -webkit-overflow-scrolling: touch;">
                                        <li class="nav-item">
                                            <button class="nav-link active" id="recent-tab" data-bs-toggle="tab"
                                                data-bs-target="#recent-tab-pane"><?php echo e(__('static.recent_chats')); ?></button>
                                        </li>
                                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="nav-item">
                                                <button class="nav-link role-tab" id="role-<?php echo e($role->id); ?>-tab" data-bs-toggle="tab"
                                                    data-role-id="<?php echo e($role->id); ?>"
                                                    data-bs-target="#role-tab-pane"><?php echo e(ucfirst($role->name)); ?> (<?php echo e($role->users_count); ?>)</button>
                                            </li>
                                        ...
                                        <div class="tab-pane fade show active" id="recent-tab-pane">
                                            <form class="chat-search-box">
                                                ...
                                                <input type="text" id="chatSearchRecent" class="form-control"
                                                    placeholder="<?php echo e(__('static.chats.search_user')); ?>">
                                            </form>
                                            <ul class="chats-user" id="recentChatsList">
                                                <?php $__empty_1 = true; $__currentLoopData = $recentChats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    <li class="chat-item" data-user-id="<?php echo e($chat['user_id']); ?>"
                                                        data-user-name="<?php echo e($chat['name']); ?>"
                                                        data-user-image="<?php echo e($chat['image']); ?>"
                                                        data-user-role="<?php echo e($chat['role']); ?>">
                                                        <div class="chat-box">
                                                            <div class="active-profile">
                                                                <?php if($chat['image']): ?>
                                                                    <img class="img-fluid rounded-circle"
                                                                        src="<?php echo e($chat['image']); ?>"
                                                                        alt="user">
                                                                <?php else: ?>
                                                                    <div class="user-round">
                                                                        <h6><?php echo e(strtoupper($chat['name'][0])); ?></h6>
                                                                    </div>
                                                                <?php endif; ?>
                                                                <span class="badge bg-danger unread-badge <?php echo e($chat['unread_count'] > 0 ? '' : 'd-none'); ?>" id="unread-<?php echo e($chat['user_id']); ?>"><?php echo e($chat['unread_count']); ?></span>
                                                            </div>
                                                    <div class="name-chat">
                                                                <div class="w-100">
                                                                    <div class="d-flex justify-content-between">
                                                                        <h5 class="chat-user-name"><?php echo e($chat['name']); ?></h5>
                                                                        <small class="text-muted chat-time"><?php echo e(\Carbon\Carbon::parse($chat['updated_at'])->diffForHumans()); ?></small>
                                                                    </div>
                                                                     <h6 class="chat-role"><?php echo e($chat['role']); ?></h6>
                                                                     <p class="last-message-text text-truncate" style="max-width: 150px; font-size: 12px; margin: 0;"><?php echo e($chat['last_message']['message'] ?? (isset($chat['last_message']['images']) && count($chat['last_message']['images']) > 0 ? 'Sent an image' : '')); ?></p>
                                                                 </div>
                                                             </div>
                                                        </div>
                                                    </li>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                    <li class="chat-item no-data-tab">
                                                        ...
                                                        <p><?php echo e(__('static.chats.no_chats_found')); ?></p>
                                                    </li>
                                                <?php endif; ?>
                                            </ul>
                                        </div>
                            ...
                            <div class="inside">
                                <div class="no-data-container" id="noDataContainer">
                                    <div class="d-flex flex-column align-items-center">
                                        ...
                                        <h4 class="mt-4"><?php echo e(__('static.chats.select_a_user')); ?></h4>
                                    </div>
                                </div>
                                        ...
                                        <div class="message">
                                            <div class="msger-chat custom-scrollbar" id="messages">
                                                <div id="loading" class="text-center p-3">
                                                    ...
                                                    <?php echo e(__('static.chats.load_message')); ?>

                                                </div>
                                                <div id="noMessages" class="text-center p-3 d-none">
                                                    <?php echo e(__('static.chats.no_messages_yet')); ?>
                                            ...
                                            <form class="msger-inputarea">
                                                <div class="position-relative">
                                                    <input class="msger-input" type="text" id="messageInput"
                                                        placeholder="<?php echo e(__('static.chats.type_message')); ?>">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-start confirmation-data">
                    ...
                    <h4 class="modal-title"><?php echo e(__('static.chats.confirmation')); ?></h4>
                    <p><?php echo e(__('static.chats.modal')); ?></p>
                    <div class="d-flex">
                        <button type="button" class="btn cancel btn-light me-2" data-bs-dismiss="modal"><?php echo e(__('static.no')); ?></button>
                        <button type="button" class="btn btn-primary delete" id="confirmClearChat"><?php echo e(__('static.yes')); ?></button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    const ACCESS_TOKEN = "<?php echo e($access_token); ?>";
    const MY_USER_ID = String("<?php echo e(auth()->id()); ?>");
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/livriko.fr/Taxido_laravel/resources/views/admin/chat/index.blade.php ENDPATH**/ ?>