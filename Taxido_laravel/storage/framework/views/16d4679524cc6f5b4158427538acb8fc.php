...
<?php $__env->startSection('content'); ?>
    <div class="row category-main g-md-4 g-3">
        <div class="col-xxl-4 col-xl-5">
            <div class="p-sticky">
                <form id="tagForm" action="<?php echo e(route('admin.tag.update', $tag->id)); ?>" method="POST">
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/livriko.fr/Taxido_laravel/resources/views/admin/tag/edit.blade.php ENDPATH**/ ?>