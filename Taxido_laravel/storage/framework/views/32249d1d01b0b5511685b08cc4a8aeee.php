<?php $__env->startSection('title', __('static.system_tools.activity_logs')); ?>
<?php $__env->startSection('content'); ?>
<div class="contentbox">
    <div class="inside">
        <div class="contentbox-title">
            <div class="contentbox-subtitle">
                <h3><?php echo e(__('static.system_tools.activity_logs')); ?></h3>
                <div class="subtitle-button-group">
                    <form action="<?php echo e(route('admin.activity-log.deleteAll')); ?>" method="POST" style="display: inline;">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('DELETE'); ?>
                        <button type="submit" class="btn btn-outline">
                            <i class="ri-delete-bin-5-line"></i> <?php echo e(__('static.delete_all')); ?>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/livriko.fr/Taxido_laravel/resources/views/admin/system-tool/activity-log.blade.php ENDPATH**/ ?>