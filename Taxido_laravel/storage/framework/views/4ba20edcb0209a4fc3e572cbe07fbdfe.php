<?php $__env->startSection('title', __('taxido::static.fleet_managers.all')); ?>
            ...
            <div class="contentbox-title">
                <div class="contentbox-subtitle">
                    ...
                    <div class="subtitle-button-group">
                        <button class="add-spinner btn btn-outline" data-url="<?php echo e(route('admin.fleet-manager.create')); ?>">
                            <i class="ri-add-line"></i> <?php echo e(__('taxido::static.fleet_managers.add_new')); ?>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/livriko.fr/Taxido_laravel/Modules/Taxido/resources/views/admin/fleet-manager/index.blade.php ENDPATH**/ ?>