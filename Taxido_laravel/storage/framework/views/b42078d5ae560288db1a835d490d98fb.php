<?php $__env->startSection('title', __('taxido::static.surge_prices.vehicle_surge_price')); ?>
            ...
            <div class="contentbox">
                <div class="inside">
                    <div class="contentbox-title">
                        <h3><?php echo e(__('taxido::static.surge_prices.vehicle_surge_price')); ?> <?php if(isset($vehicleName)): ?>
                        ...
                        <button type="button" class="btn btn-calculate" data-bs-toggle="modal"
                            ...
                            <?php echo e(__('taxido::static.surge_prices.how_is_this_calculated')); ?>
                    ...
                    <div class="accordion fare-accordion" id="surgePriceAccordion">
                        <?php $__currentLoopData = $zones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="heading-<?php echo e($zone->id); ?>">
                                    <button class="accordion-button collapsed justify-start" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#collapse-<?php echo e($zone->id); ?>"
                                        ...
                                        <?php echo e($zone->name); ?> (<?php echo e($zone->currency?->code ?? getDefaultCurrency()?->code); ?> -
                                        <?php echo e(ucfirst($zone->distance_type)); ?>)
                                    </button>
                                </h2>
                                <div id="collapse-<?php echo e($zone->id); ?>" class="accordion-collapse collapse"
                                    data-bs-parent="#surgePriceAccordion">
                                    <div class="accordion-body">
                                        <form class="surge-price-form" data-zone-id="<?php echo e($zone->id); ?>">
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" name="zone_id" value="<?php echo e($zone->id); ?>">
                                            <input type="hidden" name="vehicle_type_id" value="<?php echo e($vehicleTypeId); ?>">
                                            ...
                                            <?php $__currentLoopData = $surgePrices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $surgePrice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-12">
                                                        <h5 class="timer-price"> <span><?php echo e($surgePrice->day); ?>

                                                                (<?php echo e($surgePrice->start_time); ?> -
                                                                <?php echo e($surgePrice->end_time); ?>)
                                                            </span></h5>
                                                    </div>
                                                    <input type="hidden"
                                                        name="surge_prices[<?php echo e($surgePrice->id); ?>][surge_price_id]"
                                                        value="<?php echo e($surgePrice->id); ?>">
                                                    <input type="hidden" name="surge_prices[<?php echo e($surgePrice->id); ?>][id]"
                                                        class="price-id" value="<?php echo e($existingPrice->id ?? ''); ?>"
                                                        data-surge-price-id="<?php echo e($surgePrice->id); ?>">
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            <label for="amount-<?php echo e($surgePrice->id); ?>"
                                                                class="col-md-2"><?php echo e(__('taxido::static.surge_prices.amount')); ?></label>
                                                            <div class="col-md-10">
                                                                <div class="input-group">
                                                                    <span
                                                                        class="input-group-text currency-symbol"><?php echo e($zone->currency?->symbol ?? getDefaultCurrency()?->symbol); ?></span>
                                                                    <input type="number" class="form-control amount-field"
                                                                        id="amount-<?php echo e($surgePrice->id); ?>"
                                                                        name="surge_prices[<?php echo e($surgePrice->id); ?>][amount]"
                                                                        step="0.01"
                                                                        value="<?php echo e($existingPrice->amount ?? ''); ?>" required
                                                                        placeholder="Enter amount">
                                                                    <span class="invalid-feedback d-none"
                                                                        id="amount-<?php echo e($surgePrice->id); ?>-error"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <button type="button" class="btn ms-auto btn-primary save-surge-price-btn"
                                                <?php if(!$vehicleTypeId): ?> disabled title="Save the vehicle type first to set surge prices" <?php endif; ?>><?php echo e(__('taxido::static.surge_prices.save_surge_prices')); ?></button>
                                        </form>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-xl-4">
            <div class="p-sticky">
                <div class="contentbox">
                    <div class="inside">
                        <div class="contentbox-title">
                            <h3><?php echo e(__('taxido::static.surge_prices.publish')); ?></h3>
                        </div>
                        <div class="vehicle-detail-box">
                            <div class="cancel-ride-box">
                                <div class="vehicles-image">
                                    <img src="<?php echo e($vehicleType?->vehicle_image?->original_url); ?>" id="vehicle-image" class="img-fluid"
                                        loading="lazy">
                                </div>
                                <div class="vehicles-name">
                                    <h5 id="vehicle-name"><?php echo e($vehicleType?->name); ?></h5>
                                </div>
                                <ul class="vehicles-list" data-zone-id="<?php echo e($zones->first()->id); ?>">
                                    <li><?php echo e(__('taxido::static.surge_prices.base_fare_charge')); ?>: <span><span
                                                class="currency-symbol"><?php echo e($zones->first()->currency?->symbol ?? getDefaultCurrency()?->symbol); ?></span>101.38</span>
                                    </li>
                                    <li>
                                        <div><?php echo e(__('taxido::static.surge_prices.additional_distance_charge')); ?>:
                                            <span>(5.2Km X $8.3)</span>
                                        </div><span><span
                                                class="currency-symbol"><?php echo e($zones->first()->currency?->symbol ?? getDefaultCurrency()?->symbol); ?></span>
                                            42.90</span>
                                    </li>
                                    <li>
                                        <div><?php echo e(__('taxido::static.surge_prices.additional_minute_charge')); ?>: <span>(5.2Km
                                                X $8.3)</span></div> <span><span
                                                class="currency-symbol"><?php echo e($zones->first()->currency?->symbol ?? getDefaultCurrency()?->symbol); ?></span>
                                            12.50</span>
                                    </li>
                                    <li><?php echo e(__('taxido::static.surge_prices.platform_fee')); ?>: <span><span
                                                class="currency-symbol"><?php echo e($zones->first()->currency?->symbol ?? getDefaultCurrency()?->symbol); ?></span>
                                            10.00</span></li>
                                    <li><?php echo e(__('taxido::static.surge_prices.tax')); ?>: <span class="danger"><span
                                                class="currency-symbol"><?php echo e($zones->first()->currency?->symbol ?? getDefaultCurrency()?->symbol); ?></span>
                                            5.98</span></li>
                                    <li><?php echo e(__('taxido::static.surge_prices.commission')); ?>: <span><span
                                                class="currency-symbol"><?php echo e($zones->first()->currency?->symbol ?? getDefaultCurrency()?->symbol); ?></span>
                                            10.00</span></li>
                                    <li class="total-box"><?php echo e(__('taxido::static.surge_prices.total')); ?>: <span><span
                                                class="currency-symbol"><?php echo e($zones->first()->currency?->symbol ?? getDefaultCurrency()?->symbol); ?></span>
                                            101.38</span></li>
                                </ul>
                            </div>
                            <p class="waiting-text"><?php echo e(__('taxido::static.surge_prices.waiting_charges')); ?> <span><span
                                        class="currency-symbol"><?php echo e($zones->first()->currency?->symbol ?? getDefaultCurrency()?->symbol); ?></span>
                                    1</span> per minutes apply after the driver has been waiting for 2 minutes.</p>
                            <p class="cancel-text"><?php echo e(__('taxido::static.surge_prices.cancellation_charge')); ?> <span><span
                                        class="currency-symbol"><?php echo e($zones->first()->currency?->symbol ?? getDefaultCurrency()?->symbol); ?></span>
                                    10</span>.</p>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="fareCalculationModalLabel">
                        <?php echo e(__('taxido::static.surge_prices.surge_price_calculation')); ?></h5>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.save-surge-price-btn').on('click', function() {
                ...
                $.ajax({
                    url: "<?php echo e(url('admin/vehicle-surge-prices')); ?>",
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/livriko.fr/Taxido_laravel/Modules/Taxido/resources/views/admin/vehicle-surge-price/index.blade.php ENDPATH**/ ?>