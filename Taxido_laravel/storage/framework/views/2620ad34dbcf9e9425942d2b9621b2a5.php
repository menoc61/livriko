...
<
    ...
    <script>
        ...
        function initMap() {
            ...
            console.log('Heatmap Data:', <?php echo json_encode($heatmapPoints); ?>);
            ...
            var heatmapData = <?php echo json_encode($heatmapPoints); ?>;
        ...
        function addMapControls() {
            ...
            const buttons = [{
                    text: "<?php echo e(__('taxido::static.heatmaps.heatmap')); ?>",
                    action: toggleHeatmap
                },
                {
                    text: "<?php echo e(__('taxido::static.heatmaps.gradient')); ?>",
                    action: changeGradient
                },
                {
                    text: "<?php echo e(__('taxido::static.heatmaps.radius')); ?>",
                    action: changeRadius
                },
                {
                    text: "<?php echo e(__('taxido::static.heatmaps.opacity')); ?>",
...
</html><?php /**PATH /var/www/livriko.fr/Taxido_laravel/Modules/Taxido/resources/views/admin/heat-map/osm.blade.php ENDPATH**/ ?>