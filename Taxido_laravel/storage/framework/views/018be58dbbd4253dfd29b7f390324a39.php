<?php $__env->startSection('title', __('taxido::static.rental_vehicle.rental_vehicles')); ?>
<?php $__env->startSection('content'); ?>
    <div class="contentbox">
        <div class="inside">
            <div class="contentbox-title">
                <div class="contentbox-subtitle">
                    <h3><?php echo e(__('taxido::static.rental_vehicle.rental_vehicles')); ?></h3>
                    <div class="subtitle-button-group">
                        <button class="add-spinner btn btn-outline" data-url="<?php echo e(route('admin.rental-vehicle.create')); ?>">
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/livriko.fr/Taxido_laravel/Modules/Taxido/resources/views/admin/rental-vehicle/index.blade.php ENDPATH**/ ?>