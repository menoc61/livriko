        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exportModalLabel"><?php echo e(__('static.export.export')); ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="exportForm" class="m-0" method="GET" action="<?php echo e(route($routes ?? '')); ?>">
                    <div class="modal-body export-data">
                        ...
                        <div class="form-group mb-0">
                            <label for="exportFormat"><?php echo e(__('static.export.select_export_format')); ?></label>
                            <select id="exportFormat" name="format" class="form-select">
                                <option value="csv"><?php echo e(__('static.export.csv')); ?></option>
                                <option value="excel"><?php echo e(__('static.export.excel')); ?></option>
                            </select>
                        </div>
                        <div class="d-flex justify-content-end modal-footer">
                            <button type="button" class="btn btn-primary"
                                data-bs-dismiss="modal"><?php echo e(__('static.export.close')); ?></button>
                            <button type="submit" class="btn btn-primary"
                                id="exportBtn"><?php echo e(__('static.export.export')); ?></button>
                        </div>
                    </div>
                </form>
            </div>
...
<?php if(isset($import)): ?>
    <div class="modal fade import-modal" id="importModal">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <form id="importForm" method="POST" action="<?php echo e(route($route ?? '')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body upload-report">
                        <div class="form-group mb-0 upload-title">
                            <div class="d-flex">
                                <div class="import-icon">
                                    <svg>
                                        <use xlink:href="<?php echo e(asset('images/import.svg#import')); ?>"></use>
                                    </svg>
                                </div>
                                <div class="upload-file">
                                    <h4 for="file"><?php echo e(__('static.import.import')); ?></h4>
                                    <label for="file"><?php echo e(__('static.import.upload_instruction')); ?></label>
                                </div>
                            </div>
                            ...
                            <ul class="nav nav-tabs horizontal-tab custom-scroll" id="account" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" id="local-file-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="false">
                                        <?php echo e(__('static.import.local_files')); ?> </a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="direct-link-tab" data-bs-toggle="tab" href="#direct-link"
                                        ...
                                        <?php echo e(__('static.import.google_shit_link')); ?></a>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="file-upload-box">
                                    <div class="form-group">
                                        <div class="drop-area file-browse-button">
                                            <img src="<?php echo e(asset('images/upload.svg')); ?>" class="img-fluid" />
                                            <h5 class="file-instruction"><?php echo e(__('static.import.drag_drop')); ?>

                                            </h5>
                                            <span><?php echo e(__('static.import.private_message')); ?></span>
                                            <button class="btn"><?php echo e(__('static.import.select_files')); ?></button>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade" id="direct-link">
                                ...
                                <div class="file-upload-box">
                                    <div class="form-group">
                                        <div class="drop-area file-browse-button">
                                            <img src="<?php echo e(asset('images/googlesheet.svg')); ?>" />
                                            <h5 class="file-instruction"><?php echo e(__('static.import.enter_link')); ?>
                        ...
                        <p class="common-content"><?php echo e(__('static.import.example_csv')); ?> <a
                                href="<?php echo e(asset(@$example_file)); ?>" download class="text-primary fw-bold"> <?php echo e(__('static.import.example_csv_here')); ?>

                            </a><?php echo e(__('static.import.example_csvv')); ?> <a href="<?php echo e(asset(@$instruction_file)); ?>" download
                                class="text-primary fw-bold"> <?php echo e(__('static.import.example_csv_instructions')); ?> </a><?php echo e(__('static.import.example_csvvv')); ?></p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn"
                            data-bs-dismiss="modal"><?php echo e(__('static.import.cancel')); ?></button>
                        <button type="submit" class="btn btn-primary spinner-btn"
                            id="importSubmitBtn"><?php echo e(__('static.import.import')); ?></button>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/livriko.fr/Taxido_laravel/resources/views/inc/modal.blade.php ENDPATH**/ ?>