...
<!-- Bootstrap js -->
<script defer src="<?php echo e(asset('js/bootstrap/bootstrap.bundle.js')); ?>"></script>
<script defer src="<?php echo e(asset('js/bootstrap/popper.min.js')); ?>"></script>

<!-- Select2 -->
<script src="<?php echo e(asset('js/select2.full.min.js')); ?>"></script>

<!-- Dark Mode -->
<script defer src="<?php echo e(asset('js/dark-mode.js')); ?>"></script>

<!-- Sidebar menu js -->
<script defer src="<?php echo e(asset('js/sidebar-menu.js')); ?>"></script>
...
<script defer src="<?php echo e(asset('js/slick/slick.min.js')); ?>"></script>
...
<script>
    $(document).ready(function() {
        ...
        $('.cleaning').on('click', function() {
            $.ajax({
                url: "<?php echo e(route('admin.clear.cache')); ?>",
                method: 'GET',
                success: function() {
                    //
                }
...
<?php /**PATH /var/www/livriko.fr/Taxido_laravel/resources/views/admin/layouts/partials/script.blade.php ENDPATH**/ ?>