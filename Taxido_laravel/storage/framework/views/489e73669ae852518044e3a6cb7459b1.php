    ...
    <div class="inside">
        <div class="contentbox-title">
            <div class="contentbox-subtitle">
                <h3><?php echo e(__('ticket::static.ticket.ticket')); ?></h3>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ticket.ticket.create')): ?>
                    <a href="<?php echo e(route('admin.ticket.create')); ?>" class="btn btn-outline">
                        <i class="ri-add-line"></i><?php echo e(__('ticket::static.ticket.add_new')); ?></a>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/livriko.fr/Taxido_laravel/Modules/Ticket/resources/views/admin/ticket/index.blade.php ENDPATH**/ ?>