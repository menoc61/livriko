<?php $__env->startSection('title', __('static.tags.tags')); ?>
<?php $__env->startSection('content'); ?>
<div class="row ga- category-main g-md-4 g-3">
    <div class="col-xl-4">
        <div class="p-sticky">
            <form id="tagForm" action="<?php echo e(route('admin.tag.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
        ...
        <div class="contentbox">
            <div class="inside">
                <div class="contentbox-title">
                    <h3><?php echo e(__('static.tags.tags')); ?></h3>
                </div>
                <div class="tag-table">
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/livriko.fr/Taxido_laravel/resources/views/admin/tag/index.blade.php ENDPATH**/ ?>