                    ...
                    <div class="modal-body">
                        <form id="priceForm" action="<?php echo e(route('admin.vehicle-type-zones.store')); ?>" method="POST">
                            ...
                            <div class="row g-sm-4 g-3">
                                <div class="col-xl-4 col-lg-6 <?php echo e($isFindDriver ? 'd-none' : ''); ?>">
                                    <div class="form-group m-0">
                                        <label for="base_fare_charge" class="form-label">Base Fare
                                            Charge <?php if(!$isFindDriver): ?><span>*</span><?php endif; ?></label>
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" id="base_fare_charge"
                                                name="base_fare_charge" step="0.01" <?php echo e($isFindDriver ? '' : 'required'); ?>
                                ...
                                <div class="col-xl-4 col-lg-6 <?php echo e($isFindDriver ? 'd-none' : ''); ?>">
                                    <div class="form-group m-0">
                                        <label for="base_distance" class="form-label">Base Distance <?php if(!$isFindDriver): ?> (<i id="distanceUnit">Km</i>)<span>*</span><?php endif; ?></label>
                                        <input type="number" class="form-control" id="base_distance" name="base_distance"
                                            step="0.01" <?php echo e($isFindDriver ? '' : 'required'); ?> placeholder="Enter base distance">
                                        <span class="invalid-feedback d-none" id="base_distance_error"></span>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-6 <?php echo e($isFindDriver ? 'd-none' : ''); ?>">
                                    <div class="form-group m-0">
                                        <label for="per_distance_charge" class="form-label">Per Distance Charge <?php if(!$isFindDriver): ?> (<i id="distanceUnitPrice">Km</i>)<span>*</span><?php endif; ?></label>
                                        <div class="input-group">
                                            <span
                                                class="input-group-text currency-symbol"><?php echo e(getDefaultCurrency()?->symbol ?? 'N/A'); ?></span>
                                            <input type="number" class="form-control" id="per_distance_charge"
                                                name="per_distance_charge" step="0.01" <?php echo e($isFindDriver ? '' : 'required'); ?>
                                    ...
                                    <div class="form-group m-0">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" id="per_minute_charge"
                                                name="per_minute_charge" step="0.01" <?php echo e($isFindDriver ? '' : 'required'); ?>

                                                placeholder="Enter per minute charge">
                                        </div>
                                    </div>
                                </div>
                                <?php if(!$isFindDriver && $vehicleType->services->whereIn('type', [ServicesEnum::FREIGHT, ServicesEnum::PARCEL])->isNotEmpty()): ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            const isFindDriver = <?php echo json_encode($isFindDriver, 15, 512) ?>;
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/livriko.fr/Taxido_laravel/Modules/Taxido/resources/views/admin/vehicle-zones/index.blade.php ENDPATH**/ ?>