<?php $__env->startSection('title', __('static.blogs.blogs')); ?>
        ...
        <div class="inside">
            <div class="contentbox-title">
                <div class="contentbox-subtitle">
                    <h3><?php echo e(__('static.blogs.blogs')); ?></h3>
                    <div class="subtitle-button-group">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('blog.create')): ?>
                            <button class="add-spinner btn btn-outline" data-url="<?php echo e(route('admin.blog.create')); ?>">
                                <i class="ri-add-line"></i> <?php echo e(__('static.blogs.add_new')); ?>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/livriko.fr/Taxido_laravel/resources/views/admin/blog/index.blade.php ENDPATH**/ ?>