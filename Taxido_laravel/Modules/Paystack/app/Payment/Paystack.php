    ...
    public static function getIntent($obj, $request)
    {
        try {
            ...
            $intent = [
                ...
                'amount' => (double) currencyConvert($request->currency_code ?? getDefaultCurrencyCode(),roundNumber($obj?->total))*100,
    ...
    public static function webhook($request)
    {
        try {
            ...
            curl_setopt_array($curl, [
                CURLOPT_URL => self::getPaymentUrl().'/transaction/verify/'.$reference,
