                ...
                <div class="support-title sorting mt-0">
                    ...
                    <div>
                        ...
                        <form action="{{ route('admin.ticket.dashboard') }}" method="GET" id="sort-form">
                            ...
                            <div class="form-group {{ request('sort') == 'custom' ? '' : 'd-none' }}" id="custom-date-range">
                                <input type="text" class="form-control filter-dropdown" id="start_end_date"
                                    name="start_end_date" placeholder="{{ __('ticket::static.report.select_date') }}"
                                    value="{{ $selectedRange }}">
                            </div>
                        </form>
                    </div>
                        ...
                        <div class="card-body support-bg-img">
                            <div class="widget-content">
                                <div class="support-details">
                                    ...
                                    <div class="d-flex">
                                        @php $usersPercentage = tx_getUsersPercentage(); @endphp
                                        @if ($usersPercentage['status'] == 'decrease')
                                            <img class="me-1" src="{{ asset('images/dashboard/riders/arrow-down.svg') }}" alt="">
                                            <p class="text-danger me-2">
                                        @elseif ($usersPercentage['status'] == 'increase')
                                            <img class="me-1" src="{{ asset('images/dashboard/riders/arrow-up.svg') }}" alt="">
                                            <p class="text-primary me-2">
                                        @else
                                            <p class="text-primary me-2">
                                        @endif
                                        {{ $usersPercentage['percentage'] }}</p>
                                    </div>
                                </div>
                                <div class="widget-round b-primary">
                                    <div class="bg-round">
                                        <svg>
                                            <use xlink:href="{{ asset('images/dashboard/support/user.svg#user') }}">
                                            </use>
                                        </svg>
                                        <svg class="half-circle">
                                            <use xlink:href="{{ asset('images/dashboard/support/1.svg#support') }}">
                                            </use>
                                        </svg>
                                    </div>
                                </div>
                        ...
                        <div class="card-body support-bg-img">
                            <div class="widget-content">
                                <div class="support-details">
                                    ...
                                    <div class="d-flex">
                                        @php $deptsPercentage = tx_getDepartmentsPercentage(); @endphp
                                        @if ($deptsPercentage['status'] == 'decrease')
                                            <img class="me-1" src="{{ asset('images/dashboard/riders/arrow-down.svg') }}" alt="">
                                            <p class="text-danger me-2">
                                        @elseif ($deptsPercentage['status'] == 'increase')
                                            <img class="me-1" src="{{ asset('images/dashboard/riders/arrow-up.svg') }}" alt="">
                                            <p class="text-primary me-2">
                                        @else
                                            <p class="text-primary me-2">
                                        @endif
                                        {{ $deptsPercentage['percentage'] }}</p>
                                    </div>
                                </div>
                        ...
                        <div class="card-body support-bg-img">
                            <div class="widget-content">
                                <div class="support-details">
                                    ...
                                    <div class="d-flex">
                                        @php $ticketsPercentage = tx_getTicketsPercentage(); @endphp
                                        @if ($ticketsPercentage['status'] == 'decrease')
                                            <img class="me-1" src="{{ asset('images/dashboard/riders/arrow-down.svg') }}" alt="">
                                            <p class="text-danger me-2">
                                        @elseif ($ticketsPercentage['status'] == 'increase')
                                            <img class="me-1" src="{{ asset('images/dashboard/riders/arrow-up.svg') }}" alt="">
                                            <p class="text-primary me-2">
                                        @else
                                            <p class="text-primary me-2">
                                        @endif
                                        {{ $ticketsPercentage['percentage'] }}</p>
                                    </div>
                                </div>
                        ...
                        <div class="card-body support-bg-img">
                            <div class="widget-content">
                                <div class="support-details">
                                    ...
                                    <div class="d-flex">
                                        @php $openTicketsPercentage = tx_getOpenTicketsPercentage(); @endphp
                                        @if ($openTicketsPercentage['status'] == 'decrease')
                                            <img class="me-1" src="{{ asset('images/dashboard/riders/arrow-down.svg') }}" alt="">
                                            <p class="text-danger me-2">
                                        @elseif ($openTicketsPercentage['status'] == 'increase')
                                            <img class="me-1" src="{{ asset('images/dashboard/riders/arrow-up.svg') }}" alt="">
                                            <p class="text-primary me-2">
                                        @else
                                            <p class="text-primary me-2">
                                        @endif
                                        {{ $openTicketsPercentage['percentage'] }}</p>
                                    </div>
                                </div>
