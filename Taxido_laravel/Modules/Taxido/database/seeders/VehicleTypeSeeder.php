...
class VehicleTypeSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach($values as $value) {
            $serviceIds = getServiceIdsByTypes($value['services']);
            ...
            $vehicleType->services()->sync($serviceIds);
            $vehicleType->service_categories()->sync($service_categories);
        }
    }
}
