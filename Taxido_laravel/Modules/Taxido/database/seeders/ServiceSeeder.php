    ...
    public function run()
    {
        $services = [
            ...
            [
                ...
                'service_icon_id' => getAttachmentId('ambulance.svg'),
                'service_image_id' => getAttachmentId('ambulance.png'),
                'is_primary' => false,
            ],
            [
                'name' => ucfirst(ServicesEnum::FINDDRIVER),
                'type' => ServicesEnum::FINDDRIVER,
                'description' => 'Hire a professional and reliable driver.',
                'service_icon_id' => getAttachmentId('driver-find.svg'),
                'service_image_id' => getAttachmentId('find-driver.png'),
                'is_primary' => false,
            ]
        ];
