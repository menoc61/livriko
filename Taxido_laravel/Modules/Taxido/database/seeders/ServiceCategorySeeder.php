...
class ServiceCategorySeeder extends Seeder
{
    ...
    public function run()
    {
        $serviceCategories = [
            ...
            [
                'name' => ucfirst(ServiceCategoryEnum::ONEWAY),
                'slug' => ServiceCategoryEnum::ONEWAY,
                'service' => ServicesEnum::FINDDRIVER,
                'type' => ServiceCategoryEnum::ONEWAY,
                'description' => __('taxido::static.service_categories.scheduled_dec'),
                'service_category_image_id' => getAttachmentId('oneway.png'),
            ],
            [
                'name' => ucfirst(ServiceCategoryEnum::ROUNDTRIP),
                'slug' => ServiceCategoryEnum::ROUNDTRIP,
                'service' => ServicesEnum::FINDDRIVER,
                'type' => ServiceCategoryEnum::ROUNDTRIP,
                'description' => __('taxido::static.service_categories.scheduled_dec'),
                'service_category_image_id' => getAttachmentId('round-trip.png'),
            ],
            [
                'name' => ucfirst(ServiceCategoryEnum::OUTSTATION),
                'slug' => ServiceCategoryEnum::OUTSTATION,
                'service' => ServicesEnum::FINDDRIVER,
                'type' => ServiceCategoryEnum::OUTSTATION,
                'description' => __('taxido::static.service_categories.scheduled_dec'),
                'service_category_image_id' => getAttachmentId('outstation.png'),
            ],
            [
                'name' => ucfirst(ServiceCategoryEnum::DAILY),
                'slug' => ServiceCategoryEnum::DAILY,
                'service' => ServicesEnum::FINDDRIVER,
                'type' => ServiceCategoryEnum::DAILY,
                'description' => __('taxido::static.service_categories.scheduled_dec'),
                'service_category_image_id' => getAttachmentId('daily.png'),
            ],
