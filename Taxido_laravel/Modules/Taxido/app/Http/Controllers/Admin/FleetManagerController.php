...
class FleetManagerController extends Controller
{
    ...
    public function getUnverifiedFleetManagers(FleetManagerTable $fleetManagerTable)
    {
        request()->merge(['is_verified' => false]);
        return $this->repository->getUnverifiedFleetManagers($fleetManagerTable->generate());
    }
