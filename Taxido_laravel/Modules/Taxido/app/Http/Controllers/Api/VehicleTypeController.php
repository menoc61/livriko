...
class VehicleTypeController extends Controller
{
    ...
    {
        $this->authorizeResource(VehicleType::class,'vehicleType', ['except' => 'index', 'show']);
    ...
    public function index(Request $request)
    {
        try {
            ...
            $vehicleTypes = $vehicleTypes->where('status',true)->with(['vehicle_map_icon','vehicle_image'])->latest('created_at')->simplePaginate($request->paginate ?? $vehicleTypes->count() ?: null);
