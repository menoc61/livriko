...
class RideDetailResource extends BaseResource
{
    ...
    public function toArray(Request $request): array
    {
        $ride = [
            ...
            'payment_method_logo' => $this->getPaymentLogo($this->payment_method),
            'payment_status' => $this->payment_status,
            'ride_status' => $this->ride_status?->name,
            'coupon_total_discount' => $this->coupon_total_discount,
            'extra_charge' => $this->total_extra_charge,
            'zones' => $this->zones,
            'bids' => $this->bids->map(function($bid) {
                return [
                    ...
                    'driver' => [
                        ...
                        'profile_image' => [
                            'original_url' => $bid->driver?->profile_image?->original_url
                        ],
                        'reviews' => $bid->driver?->reviews
                    ]
                ];
            }),
    ...
    protected function getPaymentLogo($slug)
    {
        ...
        return asset('images/payment/cod.png');
    }
}
