                ...
                <div class="inside">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2"
                            for="service_image_id">{{ __('taxido::static.services.image') }}<i class="ri-error-warning-line" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                                                    data-bs-title="*Upload image size 170x110px recommended"></i></label>
                        <div class="col-md-10">
                            <div class="form-group">
                                <x-image :text="__('static.svg_not_supported')" :unallowed_types="['svg']" :name="'service_image_id'" :data="isset($service->service_image)
                                    ? $service?->service_image
                                    : old('service_image_id')"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                <x-image :allowed_types="'svg'" :text="__('static.allowed_mimetypes', ['mimetype' => 'SVG'])" :name="'service_icon_id'" :data="isset($service->service_icon)
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10 select-label-error">
                            <select class="select-2 form-control" id="type" name="type"
                                ...
                                @foreach (['cab' => 'Cab', 'parcel' => 'Parcel', 'freight' => 'Freight', 'ambulance' => 'Ambulance', 'finddriver' => 'Find Driver'] as $key => $option)
