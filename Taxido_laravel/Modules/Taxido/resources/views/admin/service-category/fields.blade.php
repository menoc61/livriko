                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    <x-image :text="__('static.svg_not_supported')" :unallowed_types="['svg']" :name="'service_category_image_id'" :data="isset($serviceCategory->service_category_image)
                                ...
                                <div class="editor-space">
                                    <label class="switch">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="visible" id=""
                                            value="1" @checked(@$serviceCategory?->visible ?? true)>
                                        <span class="switch-state"></span>
                                    </label>
                                </div>
                                @error('visible')
