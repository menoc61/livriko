                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                <x-image :text="__('static.svg_not_supported')" :unallowed_types="['svg']" :name="'banner_image_id'" :data="isset($banner->banner_image)
                                    ? $banner?->banner_image
                                    : old('banner_image_id')" :text=" __('taxido::static.banners.recommended')"
